...
<section>  
 <ul>
   <a href="#t1"><li class="icon fa fa-home" id="uno">Home</li></a>
   <a href="#t2"><li class="icon fa fa-keyboard-o" id="dos">test1</li></a>
   <a href="#t3"><li class="icon fa fa-coffee" id="tres">test2</li></a>
   <a href="#t4"><li class="icon fa fa-dribbble" id="cuatro">test3</li></a>
 </ul>
